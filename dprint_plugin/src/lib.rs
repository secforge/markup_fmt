...
impl SyncPluginHandler<FormatOptions> for MarkupFmtPluginHandler {
    fn plugin_info(&mut self) -> PluginInfo {
        ...
        PluginInfo {
            ...
            help_url: "https://github.com/secforge/markup_fmt".to_string(),
            config_schema_url: format!(
                "https://github.com/secforge/markup_fmt/releases/download/v{version}/schema.json",
            ),
            update_url: Some("https://github.com/secforge/markup_fmt/releases/latest/download/plugin.wasm".into()),
        }
    }
